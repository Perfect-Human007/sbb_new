...
<head>
    ...
    <title>Admin Panal - packages</title>
...
?>
      ...
      <div class="row">
        <div class="col-lg-10 ms-auto p-4 overflow-hidden">
           ...
           <div class="card border-0 shadow-sm mb-4">
              <div class = "card-body">
              <p class="text-align-right">Before deteing a Package/Room -> Please <span class="fw-bold">Uncheck and Update</span> all the facilities and features from the edit option. </p>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="row">
              ...
              <input type="hidden"  name="packages_id">
            </div>
          </div>
          <div class="modal-footer">
            <button type="reset" onclick="" class="btn btn-danger" data-bs-dismiss="modal">Cancel</button>
    ...
    <div class="modal fade" id="package-images" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Package/Room name</h5>
