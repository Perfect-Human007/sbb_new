<?php
         ...
         while($row = mysqli_fetch_assoc($res)){
            ...
            echo <<<data
               ...
               <tr>
                  <td>$i</td>
                  <td>$row[name]</td>
                  <td> <button type="button" onclick="rem_feature($row[id])" class="btn btn-danger btn-sm shadow-none">
      ...
      if(isset($_POST['add_facility']))
      {
         ...
         $frm_data = filteration($_POST);
         $img_r =  uploadSVGIamge($_FILES['icon'],FACILITIES_FOLDER);
      ...
      if(isset($_POST['rem_facility']))
      {
            ...
            $check_q = select('SELECT * FROM `package_facilities` WHERE `facilities_id`=?', [$frm_data['rem_facility']],'i');
