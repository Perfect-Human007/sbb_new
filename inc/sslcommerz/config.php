<?php
    ...
    if (!defined('PROJECT_PATH')) {
        define('PROJECT_PATH', 'http://localhost/sbb'); // replace this value with your project path
    }
    ...
    if (!defined('STORE_ID')) {
        define('STORE_ID', 'jsbus64d393e3d5b8d'); // your store id. For sandbox, register at https://developer.sslcommerz.com/registration/
    }

    if (!defined('STORE_PASSWORD')) {
        define('STORE_PASSWORD', 'jsbus64d393e3d5b8d@ssl'); // your store password.
    }
