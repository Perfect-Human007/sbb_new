<?php
    ...
    if(isset($_POST['info_form']))
    {
       ...
       $query = "UPDATE `user_cred` SET `name`=?, `address`=?, `phonenum`=?, `dob`=?, `pincode`=? WHERE `id`=? LIMIT 1";

       $values = [$frm_data['name'],$frm_data['address'],$frm_data['phonenum'],$frm_data['dob'],$frm_data['pincode'],$_SESSION['uId']];
