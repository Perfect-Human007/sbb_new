<?php
    ...
    function send_mail($uemail,$token,$type){
        ...
        $email->addContent(
            "text/html", 
            "<strong>Click the link to $content: <br>
    ...
    if(isset($_POST['register']))
    {
      ...
      $img = uploadUserIamge($_FILES['profile']);
      ...
      $token = bin2hex(random_bytes(16));
       ...
       $query = "INSERT INTO `user_cred`( `name`, `email`, `address`, `phonenum`, `dob`, `profile`, `password`, `token`,`pincode`) VALUES (?,?,?,?,?,?,?,?,?)";

       $values = [$data['name'],$data['email'],$data['address'],$data['phonenum'],$data['dob'],$img,$enc_pass,$token,$data['pincode']];
